package com.commentaire.mcommentaire.configurations;


import com.commentaire.mcommentaire.filter.CustomBearerTokenAuthenticationFilter;
import com.commentaire.mcommentaire.security.CustomAuthenticationEntryPoint;
    ...
    public SecurityFilterChain filterChain(
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(customizer -> customizer
                        .requestMatchers(HttpMethod.GET, "/commentaire/health/readiness").permitAll()
