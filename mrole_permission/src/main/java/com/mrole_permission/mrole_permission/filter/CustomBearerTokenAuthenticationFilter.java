package com.mrole_permission.mrole_permission.filter;

import com.mrole_permission.mrole_permission.client.UserServiceClient;

import com.mrole_permission.mrole_permission.model.auth.Token;
    ...
    protected void doFilterInternal(@NonNull final HttpServletRequest httpServletRequest,
        ...
        if (Token.isBearerToken(authorizationHeader)) {
            ...
            try {
                ...
                log.error("khalil Token validation failed for request: {}", httpServletRequest.getRequestURI(), e);
