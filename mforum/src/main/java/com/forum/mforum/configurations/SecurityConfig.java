...
import com.forum.mforum.filter.CustomBearerTokenAuthenticationFilter;
import com.forum.mforum.security.CustomAuthenticationEntryPoint;
    ...
    public SecurityFilterChain filterChain(
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(customizer -> customizer
                        .requestMatchers(HttpMethod.GET, "/forum/health/readiness").permitAll()
